...
@section('title', 'لازورد — مختبر الأسنان الرقمي')
    ...
    <section class="hero" id="home">
        <div class="hero-container">
            ...
            <div class="hero-content">
                ...
                <p>نحن نعمل على تمكين الآلاف من عيادات طب الأسنان من خلال تدفقات عمل مبتكرة لتعزيز رعاية المرضى وإحداث ثورة في طريقة تقديم طلباتهم والتعاون في العمل المختبري.</p>
                <div class="hero-btns">
        ...
        <div class="container">
            ...
            <div class="results-grid">
                <div class="result-card">
                    <img src="{{ asset('images/result-1.jpg') }}" alt="تطوير مهارات الفريق" />
                    <h3>تطوير مهارات كل عضو من الموظفين</h3>
                    <p>احمل كل عضو من أعضاء فريقك بثقة على سير عمل رقمي — استفد من التدريب غير المحدود لفريقك كلما دعت الحاجة.</p>
                </div>
                <div class="result-card">
                    <img src="{{ asset('images/result-2.jpg') }}" alt="تحسين تجربة المريض" />
                    <h3>تحسين تجربة المريض</h3>
                    <p>ارفع مستوى رعاية المريض من خلال ابتكارات مثل أطقم الأسنان ذات الموعد المباشرة، والأجزاء الجزئية المباشرة، والمسح الضوئي الترميمي.</p>
                </div>
                <div class="result-card">
                    <img src="{{ asset('images/result-3.jpg') }}" alt="زيادة القدرة على التنبؤ بالعلاج" />
                    <h3>زيادة القدرة على التنبؤ بالعلاج</h3>
                    <p>استخدم أدوات المسح المتقدمة — تصور التصاميم الرقمية والموافقة عليها، وتعزيز قبول الحالة، وتقديم نتائج ناجحة للمرضى.</p>
                </div>
            </div>
        </div>
    </section>
